                        ...
                        <tbody>
                            <?php foreach ($data as $p): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="set.php?id=<?= $p['id']; ?>&status=disetujui" class="btn btn-success btn-sm rounded-pill px-3 me-1"><i class="bi bi-check2"></i> Setujui</a>
                                        <a href="set.php?id=<?= $p['id']; ?>&status=ditolak" class="btn btn-danger btn-sm rounded-pill px-3 me-1"><i class="bi bi-x-lg"></i> Tolak</a>
                                        <a href="hapus.php?id=<?= $p['id']; ?>" class="btn btn-danger btn-sm rounded-pill px-3 ms-1" onclick="return confirm('Hapus data ini?')"><i class="bi bi-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>

        ...
        <div class="row align-items-center mb-4 g-3">
            ...
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active text-primary-custom" aria-current="page">Manajemen Berita</li>
                    </ol>
                </nav>
                <h3 class="fw-bold text-primary-custom mb-1">Manajemen Berita</h3>
                <p class="text-muted small mb-0">Kelola artikel berita, pengumuman, dan informasi terbaru.</p>
            </div>
        ...
        <div class="section-container">
            ...
            <div class="row mb-4">
                <div class="col-md-5 col-lg-4">
                    <div class="position-relative">
                        ...
                        <input type="text" id="searchInput" class="form-control search-input" placeholder="Cari judul berita...">
                    </div>
                </div>
            </div>
            ...
            <?php if (empty($berita)): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted small">Silakan tambahkan berita baru untuk ditampilkan di website.</p>
                </div>
            <?php else: ?>
                <div class="table-responsive">
                    <table class="table table-custom table-hover align-middle mb-0" id="beritaTable">
                        <thead>
                            <tr>
                                <th width="15%">Cover</th>
                                <th width="45%">Judul & Penulis</th>
                                ...
                                <tr>
                                    <td>
                                        <?php if (!empty($b['gambar'])): ?>
                                            <img src="../../public/uploads/berita/<?= htmlspecialchars($b['gambar']) ?>" class="thumb-img" alt="Cover">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="fw-bold text-dark search-target mb-1"><?= htmlspecialchars($b['judul']) ?></div>
                                        <div class="small text-muted">
                                            <i class="bi bi-person me-1"></i><?= htmlspecialchars($b['penulis'] ?? 'Admin') ?>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="edit.php?id=<?= $b['id']; ?>" class="btn btn-warning btn-sm rounded-pill px-3 fw-bold text-dark border-0 shadow-sm" title="Edit Data">
                                                <i class="bi bi-pencil-square me-1"></i> Edit
                                            </a>
                                            <a href="hapus.php?id=<?= $b['id']; ?>" class="btn btn-danger btn-sm rounded-pill px-3 fw-bold border-0 shadow-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus berita ini?')" title="Hapus Data">
